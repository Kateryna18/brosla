(() => {
    ...
    function showMore() {
            ...
            if (targetType === "click") {
                if (targetEvent.closest("[data-showmore-button]")) {
                    ...
                    if (!showMoreContent.classList.contains("_slide")) {
                        if (showMoreBlock.classList.contains("_showmore-active")) _slideUp(showMoreContent, showMoreSpeed, hiddenHeight); else _slideDown(showMoreContent, showMoreSpeed, hiddenHeight);
                        showMoreBlock.classList.toggle("_showmore-active");
                        toggleIcons(showMoreButton, showMoreBlock.classList.contains("_showmore-active"));
                    }
                }
        ...
        function toggleIcons(button, isActive) {
            const icons = button.querySelectorAll(".video__button-icon");
            if (icons.length === 2) {
    ...
    function changeActiveLink() {
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            menuLinks.forEach((link => {
                ...
                if (currentUrl.includes(linkHref)) link.classList.add("active"); else link.classList.remove("active");
            }));
        }));
    }
    ...
    function initSliders() {
        ...
        if (document.querySelector(".catalogs__slider")) if (window.innerWidth <= 768) {
            if (!swiperInstance) swiperInstance = new swiper_core_Swiper(".catalogs__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
